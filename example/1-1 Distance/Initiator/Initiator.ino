...
void setup(){
  ...
  // DW1000Ranging.startAsInitiator(DEVICE_ADDR, DW1000.MODE_2,false,MASTER);
  // DW1000Ranging.startAsInitiator(DEVICE_ADDR, DW1000.MODE_3,false,MASTER);
  // DW1000Ranging.startAsInitiator(DEVICE_ADDR, DW1000.MODE_4,false,MASTER);
  // DW1000Ranging.startAsInitiator(DEVICE_ADDR, DW1000.MODE_5,false,MASTER);
  // DW1000Ranging.startAsInitiator(DEVICE_ADDR, DW1000.MODE_6,false,MASTER);
}
